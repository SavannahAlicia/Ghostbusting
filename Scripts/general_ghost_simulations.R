...
saveRDS(mesh,'simulations_mesh.rds')
...
saveRDS(lp_ld_capthists_ghost,'sim_capthists_lp_ld.rds')
saveRDS(lp_hd_capthists_ghost,'sim_capthists_lp_hd.rds')
saveRDS(hp_ld_capthists_ghost,'sim_capthists_hp_ld.rds')
saveRDS(hp_hd_capthists_ghost,'sim_capthists_hp_hd.rds')
...
saveRDS(lp_ld_scr_fits,'simulations_scr_lp_ld.rds')
...
saveRDS(lp_ld_min2_scr_fits,'simulations_scr2_lp_ld.rds')
...
saveRDS(lp_hd_scr_fits,'simulations_scr_lp_hd.rds')
...
saveRDS(lp_hd_min2_scr_fits,'simulations_scr2_lp_hd.rds')
...
saveRDS(hp_ld_scr_fits,'simulations_scr_hp_ld.rds')
...
saveRDS(hp_ld_min2_scr_fits,'simulations_scr2_hp_ld.rds')
...
saveRDS(hp_hd_scr_fits,'simulations_scr_hp_hd.rds')
...
saveRDS(hp_hd_min2_scr_fits,'simulations_scr2_hp_hd.rds')